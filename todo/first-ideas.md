...
# Implémenter give_effects qui va prendre en paramètre un enum et qui va utiliser un switch
# Pour choisir le tier a donner, va renvoyer : (a voir en fonction de curios / implémentation d'effet par joueur...)
